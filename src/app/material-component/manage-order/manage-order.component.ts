...
export class ManageOrderComponent implements OnInit {
  ...
  add() {
    ...
    if (productName === undefined) {
      ...
      this.menubarService.openMenuBar(GlobalConstants.productAdded, "success");
    }
    else {
      this.menubarService.openMenuBar(GlobalConstants.productExistError, GlobalConstants.error);
    }
  }
